        ...
        if (isFirstTime) {
            ...
            this.layers = {
                ...
                stadtplan: new OpenLayers.Layer.WMTS({
                    name: 'Stadtplan',
                    url: 'https://www.geodaten-mv.de/dienste/orka_wmts/wmts/orkamv/{TileMatrixSet}/{TileMatrix}/{TileCol}/{TileRow}.png',
                    layer: 'orkamv',
                    matrixSet: 'epsg_25833_adv',
                    matrixIds: ['7', '8', '9', '10', '11', '12', '13', '14'],
                    format: 'png',
                    style: 'default',
            ...
            this.map = this.view.initMap({
                ...
                resolutions: [38.2185141426, 19.1092570713, 9.5546285356, 4.7773142678, 2.3886571339, 1.194328567, 0.5971642835, 0.2985821417],
                units: 'm',
                maxExtent: new OpenLayers.Bounds(-464849.38, 5057815.86858, 787494.891424, 6310160.14),
                restrictedExtent: new OpenLayers.Bounds(387869, 5988667, 403158, 6007338)
            },
            this.layers,
            {
                styles: this.styles,
